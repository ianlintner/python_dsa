...
def bounded_knapsack(weights: List[int], values: List[int], counts: List[int], capacity: int) -> int:
    """
...
def multiple_knapsack(weights: List[int], values: List[int], counts: List[int], capacity: int) -> int:
    """
