...
def counting_sort(nums: List[int], min_val: Optional[int] = None, max_val: Optional[int] = None, stable: bool = True) -> List[int]:
    """
...
def counting_sort_by_key(items: List[Any], key: Callable[[Any], int], key_min: Optional[int] = None, key_max: Optional[int] = None) -> List[Any]:
    """
...
def demo():
    ...
    print("  - Radix sort: large n with bounded digits/lengths; when comparison sort overhead is high")
    print()
