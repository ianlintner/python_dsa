...
def demo():
    ...
    test_cases = [
        ...
        {"values": [1], "expected": [1], "description": "Single node"},
        {"values": [1, 2], "expected": [1, 2], "description": "Two nodes"},
        {"values": [1, 2, 3], "expected": [1, 3, 2], "description": "Three nodes"},
        {"values": [1, 2, 3, 4, 5, 6], "expected": [1, 6, 2, 5, 3, 4], "description": "Six nodes"},
    ]
