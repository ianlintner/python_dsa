...
def demo():
    ...
    test_cases = [
        ...
        {"values": [1, 2], "expected": [2, 1], "description": "Example 2: two nodes"},
        {"values": [], "expected": [], "description": "Example 3: empty list"},
        {"values": [1], "expected": [1], "description": "Single node"},
        {"values": [1, 2, 3], "expected": [3, 2, 1], "description": "Three nodes"},
    ]
