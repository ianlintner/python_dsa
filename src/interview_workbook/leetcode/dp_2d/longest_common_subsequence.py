...
TEST_CASES = [
    TestCase(
        ...
        expected=3,
        description="Basic LCS example - 'ace'"
    ),
    TestCase(
        input_data=("abc", "abc"),
        expected=3,
    ...
    TestCase(
        input_data=("ABCDGH", "AEDFHR"),
        expected=3,
        description="Mixed case LCS - 'ADH'"
    ),
    TestCase(
    ...
    TestCase(
        input_data=("longest", "stone"),
        expected=3,
        description="LCS 'one' or similar"
    ),
    TestCase(
