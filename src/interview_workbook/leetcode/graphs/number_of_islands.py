...
def create_demo_output() -> str:
    ...
    demo_parts.append("2. **State Management**: Decide between in-place modification vs. visited array")
    demo_parts.append("3. **Direction Arrays**: Use [(1,0), (-1,0), (0,1), (0,-1)] for cleaner code")
...
register_problem(
    ...
    solution_func=lambda grid: Solution().numIslands([row[:] for row in grid]),  # Copy to avoid mutation
