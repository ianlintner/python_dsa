...
def demo():
    ...
    test_cases = [
        {"name": "Example 1: balanced tree", "input": [3, 9, 20, None, None, 15, 7], "expected": 3},
        {"name": "Example 2: right skewed", "input": [1, None, 2], "expected": 2},
        {"name": "Single node", "input": [1], "expected": 1},
        {"name": "Empty tree", "input": [], "expected": 0},
        {"name": "Left skewed tree", "input": [1, 2, None, 3, None, 4], "expected": 4},
        {"name": "Complete binary tree", "input": [1, 2, 3, 4, 5, 6, 7], "expected": 3},
        {
            "name": "Deep tree",
