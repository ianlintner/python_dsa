...
def demo():
    ...
    test_cases = [
        ...
        {"name": "Example 2: simple tree", "input": [2, 1, 3], "expected": [2, 3, 1]},
        {"name": "Single node", "input": [1], "expected": [1]},
        {"name": "Empty tree", "input": [], "expected": []},
        {"name": "Left skewed tree", "input": [1, 2, None, 3], "expected": [1, None, 2, None, 3]},
        {"name": "Right skewed tree", "input": [1, None, 2, None, 3], "expected": [1, 2, None, 3]},
        {
