...
TEST_CASES = [
    TestCase(
        ...
        input_args=input_args=([10, 5, 2, 6], 100,
    ),
        expected=8,
    ...
    TestCase(
        description="No valid subarrays",
        input_args=input_args=([10, 20, 30], 5,
    ),
        expected=0,
        description="All elements >= k",
    ),
    TestCase(
        description="All elements valid",
        input_args=input_args=([1, 1, 1], 10,
    ),
        expected=6,
    ...
    TestCase(
        ...
        input_args=input_args=([1, 2, 3, 4, 5], 10,
    ),
        expected=11,
