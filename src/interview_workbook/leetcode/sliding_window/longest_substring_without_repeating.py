...
def demo():
    ...
    test_cases = [
        TestCase(
            input_args=("abcabcbb",), 
            expected=3,
            description="Basic case - 'abc' is longest"
        ),
        TestCase(
            input_args=("bbbbb",), 
            expected=1,
            description="All same characters - 'b'"
        ),
        TestCase(
            input_args=("pwwkew",), 
            expected=3,
            description="Mixed case - 'wke' is longest"
        ),
        TestCase(
            input_args=("",), 
            expected=0,
        ...
        TestCase(
            input_args=("au",), 
            expected=2,
            description="Two unique characters"
        ),
        TestCase(
            input_args=("dvdf",), 
            expected=3,
            description="'vdf' is longest"
        ),
        TestCase(
            input_args=("anviaj",), 
            expected=5,
            description="'nviaj' is longest"
        ),
        TestCase(
            input_args=("abcdef",), 
            expected=6,
