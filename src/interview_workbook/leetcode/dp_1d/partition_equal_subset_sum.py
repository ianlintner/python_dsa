...
TEST_CASES = [
    TestCase(
        input_args=([1, 5, 11, 5],), expected=True, description="Can partition into [1,5,5] and [11]"
    ),
    ...
    TestCase(input_args=([2, 2, 1, 1],), expected=True, description="Can partition into [2,1] and [2,1]"),
    TestCase(
        input_args=([1, 2, 3, 4, 5, 6, 7],),
        expected=True,
        description="Sum=28, can partition into sum=14 each",
    ),
    TestCase(input_args=([100],), expected=False, description="Single element cannot be partitioned"),
    TestCase(
        input_args=([
            1,
            1,
    ...
    TestCase(
        input_args=([3, 3, 3, 4, 5],), expected=True, description="Can partition into [3,3,4] and [3,5]"
    ),
]
