...
TEST_CASES = [
    ...
    TestCase(
        input_args=input_args=([[1, 3], [2, 4], [3, 5], [4, 6]],,
    ),
        expected=2,
        description="Overlapping chain of meetings",
    ),
    TestCase(
        input_args=input_args=([[1, 10], [2, 3], [4, 5], [6, 7], [8, 9]],,
    ),
        expected=2,
