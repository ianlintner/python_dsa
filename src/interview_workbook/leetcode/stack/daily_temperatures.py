...
test_cases = [
    ...
    TestCase(([30, 60, 90],), [1, 1, 0], 
             "Example 3: Each day warmer than previous"),
    TestCase(([90, 60, 30],), [0, 0, 0], 
             "Decreasing temperatures - no warmer days"),
    TestCase(([75],), [0], 
             "Single temperature - no future day"),
    TestCase(([75, 75],), [0, 0], 
             "Equal temperatures - neither is warmer"),
    TestCase(([70, 70, 70, 75],), [3, 2, 1, 0], 
             "Equal temps then warmer"),
    TestCase(([80, 70, 60, 70, 90],), [4, 3, 1, 1, 0], 
             "Complex pattern with dips and peaks"),
    TestCase(([60, 70, 65, 75],), [1, 2, 1, 0], 
             "Up-down-up pattern"),
    TestCase(([100, 99, 98, 97, 96, 95],), [0, 0, 0, 0, 0, 0], 
...
def demo() -> str:
    ...
    test_results = run_test_cases(solution.dailyTemperatures, test_cases, "LeetCode 739: Daily Temperatures")
